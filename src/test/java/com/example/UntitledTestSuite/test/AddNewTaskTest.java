...
public class AddNewTaskTest extends AuthBase{

    static List<TaskData> testTasks() throws Exception {
        return TestDataLoader.loadTasksFromResource("addTasks.xml");
    }
    ...
    public void testAddNewTask(TaskData task) throws Exception {
        ...
        manager.getTaskHelper().verifyTaskExists(task);
    }
